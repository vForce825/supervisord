...
----------kms
````
wget https://raw.githubusercontent.com/wxliuxh/supervisord/master/kms-x86 -O /usr/bin/kms-server --no-check-certificate
#wget https://raw.githubusercontent.com/wxliuxh/supervisord/master/kms-x64 -O /usr/bin/kms-server --no-check-certificate
